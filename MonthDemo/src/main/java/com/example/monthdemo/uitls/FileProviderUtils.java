...
public class FileProviderUtils {
     ...
     * @return 文件对应的URI
     */
    public static Uri uriFromFile(Activity activity, File file,String p) {
        Uri fileUri;
        //7.0以上进行适配
    ...
    public static void setIntentDataAndType(Activity activity,
        ...
        //7.0以上进行适配
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            intent.setDataAndType(uriFromFile(activity, file,PhotosUtils.FILE_PROVIDER_AUTHORITY), type);
            //临时赋予读写Uri的权限
